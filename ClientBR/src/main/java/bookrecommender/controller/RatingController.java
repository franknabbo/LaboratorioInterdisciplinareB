...
public class RatingController {
    ...
    public void addRating(int idLibro, int styleRating, int contentRating, int appealRating,
        ...
        try {
            ...
            } else if (response.startsWith("RATING_FAILED:Il libro non è presente nella libreria dell'utente")) {
            ...
            } else if (response.startsWith("RATING_FAILED:Esiste già una valutazione per questo libro da parte di questo utente")) {
                alertController.showAlert("Errore pubblicazione recensione", "Esiste già una valutazione per questo libro da parte di questo utente");
            }
        } catch (IOException e) {
