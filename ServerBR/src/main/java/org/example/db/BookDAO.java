...
public class BookDAO {
    ...
    public List<Book> getBooks(int limit) {
        ...
        String sql = "SELECT * FROM Libri ORDER BY id_libro LIMIT ?";
        ...
        try {
            ...
            while (rs.next()) {
                books.add(new Book(
                        ...
                        rs.getString("copertina") // Recupero la copertina dal database
                ));
            }
    ...
    /**
     * Ricerca libri per titolo (case insensitive, ricerca parziale)
     */
    public List<Book> searchBooksByTitle(String title) {
        List<Book> books = new ArrayList<>();
        String sql = "SELECT * FROM Libri WHERE LOWER(titolo) LIKE LOWER(?) ORDER BY id_libro";
        ...
        try {
            ...
            System.err.println("Errore nella ricerca per titolo: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    /**
     * Ricerca libri per autore (case insensitive, ricerca parziale)
     */
    public List<Book> searchBooksByAuthor(String author) {
        List<Book> books = new ArrayList<>();
        String sql = "SELECT * FROM Libri WHERE LOWER(autore) LIKE LOWER(?) ORDER BY id_libro";
    ...
    public List<Book> searchBooksByAuthorAndYear(String author, int year) {
        List<Book> books = new ArrayList<>();
        String sql = "SELECT * FROM Libri WHERE LOWER(autore) LIKE LOWER(?) AND anno_pubblicazione = ? ORDER BY id_libro";
        ...
        try {
            ...
            System.err.println("Errore nella ricerca per autore e anno: " + e.getMessage());
            e.printStackTrace();
        }
